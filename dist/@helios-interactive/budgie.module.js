...
var imageExtensions = [ "jpg", "gif", "png", "bmp", "jpeg" ], videoExtensions = [ "mp4", "ogg", "webm" ], BudgieDom = Object.create({
    ...
    setupBudgieScrollProperties: function(budgie) {
        var scrollProperty = budgie.scrollProperty(), budgieElement = BudgieDom.measureElementWidthAndHeight(".budgie-item-" + budgie.budgieId), budgieElementMeasure = budgie.isHorizontal() ? budgieElement.width : budgieElement.height;
    ...
    return _createClass(Budgie, [ {
        ...
        value: function() {
            ...
            if (this.options.autoScroll) {
                ...
                this.stopAnimate(), this.fitsInContainer() ? this.budgieContainer.parentElement[scrollDirection] = 0 : this.interval = setInterval(function() {
